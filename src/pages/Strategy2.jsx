...
const Strategy2 = ({ step }) => {
  return (
    ...
    >
      {/* Timeline Divider for mobile (left) */}
    <div className="md:hidden absolute left-4 top-0 h-full flex items-center">
  <div className="w-[3px] h-full bg-[#89c9ed] relative">
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border-4 border-[#89c9ed] w-8 h-8 rounded-full flex items-center justify-center z-10">
      ...
      {/* Left Section (Image with animation from left) */}
      <motion.div
        className="md:w-1/2 px-6 flex justify-center order-1 md:order-1 mb-6 md:mb-0"
      ...
      <div className="hidden md:flex items-center px-4 relative order-2">
        <div className="w-[3px] bg-[#89c9ed] h-full relative">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border-4 border-[#89c9ed] w-10 h-10 rounded-full flex items-center justify-center z-10">
      ...
      {/* Right Section (Text) */}
      <div className="md:w-1/2 px-6 md:px-20 order-2 md:order-3">
